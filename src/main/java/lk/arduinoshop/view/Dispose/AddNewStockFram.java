 ...
 */
public class AddNewStockFram extends javax.swing.JFrame {

    private String selectedImagePath = null;

    public AddNewStockFram() {
        initComponents();
    ...
    private void addbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbuttonActionPerformed
        ...
        boolean addNewStockResult = false;
        addNewStockResult = ProductController.addStock(productDTO);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewStockFram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddNewStockFram().setVisible(true);
            }
        });
    }
