 ...
 */
public class DeleteNewItemFrame1 extends javax.swing.JFrame {

    

    public DeleteNewItemFrame1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteNewItemFrame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteNewItemFrame1().setVisible(true);
            }
        });
    }
